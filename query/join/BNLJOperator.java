...
public class BNLJOperator extends JoinOperator {
    ...
    private class BNLJIterator implements Iterator<Record>{
        ...
        private void fetchNextLeftBlock() {
            ...
            this.leftBlockIterator = leftSource.getBlockIterator(leftSourceIterator, leftSource.getSchema(), numBuffers - 2);
        ...
        private void fetchNextRightPage() {
            ...
            this.rightPageIterator = rightSource.getBlockIterator(rightSourceIterator, rightSource.getSchema(), 1);
